;;; php-skeleton-var.el --- Skeleton template for PHP Variable handling functions
...
;; https://php.net/manual/en/ref.var.php
...
(provide 'php-skeleton-var)
;;; php-skeleton-var.el ends here
